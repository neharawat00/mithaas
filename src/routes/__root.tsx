...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mithaas — Where Every Bite Feels Like Home" },
      {
        name: "description",
        content:
          "Mithaas is a premium Indian restaurant: order online, reserve a table and explore a handcrafted menu of authentic flavours.",
      },
      { name: "theme-color", content: "#1b1512" },
